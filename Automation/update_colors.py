...
source_line_switch_template = '            case .{name}: return.{name}'
...
if __name__ == "__main__":
  ...
  for key, value in sorted(colors.items()):
      ...
      sourceColorSwitchLines.append(source_line_switch_template.format(name = name))
  ...
  updatedSourceContent = source_template.format(colorList = '\n'.join(sourceColorLines), caseList = '\n'.join(sourceColorSwitchLines))
